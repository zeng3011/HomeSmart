package object.homesmart.gogo.content;
...
public class ContentCommon {
	...
	public static final String ADD_KEY_EXIT = "add_one_key_exit";

	public static final String MAIN_KEY_EXIT = "main_exit";
	...
	public static final String SDCARD_PATH = "WIFI BELL";
	...
	public static final String MSG_PUSH_SWITCH_OPEN = "push_switch_open";
	public static final String MSG_PUSH_SWITCH_CLOSE = "push_switch_close";
	
	public static final String JPUSH_ALIS_OK = "jpush_set_alis_ok";
	public static final String JPUSH_ALIS_FAIL = "jpush_set_alis_fail";
	
	public static final String XG_REGISTER_OK = "xgpush_register_ok";
	public static final String XG_REGISTER_FAIL = "xgpush_register_fail";
	...
	public static final int PPPP_NOT_INITIALIZED = -1;/* connecting */ //服务器未初始化
	public static final int PPPP_STATUS_CONNECTING = 0;/* connecting */ //正在连接
	public static final int PPPP_STATUS_INITIALING = 1;/* initialing */ //已连接 正在初始化
	public static final int PPPP_STATUS_ON_LINE = 2;/* on line */  //在线
	public static final int PPPP_STATUS_CONNECT_FAILED = 3;/* connect failed */ //连接失败
	public static final int PPPP_STATUS_DISCONNECT = 4;/* connect is off */ //断线
	public static final int PPPP_STATUS_INVALID_ID = 5; //ID号无效
	public static final int PPPP_STATUS_DEVICE_NOT_ON_LINE = 6; //不在线
	public static final int PPPP_STATUS_CONNECT_TIMEOUT = 7; //连接超时
	public static final int PPPP_STATUS_CONNECT_ERRER = 8; //该用户不存在
	public static final int PPPP_STATUS_USER_LOGIN = 9; //其它手机已连接
	public static final int PPPP_STATUS_PWD_CUO = 10; //密码错误
